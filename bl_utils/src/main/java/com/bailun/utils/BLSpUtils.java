 ...
 * @date 2019/11/19
 */
public class BLSpUtils {

    private BLSpUtils() {
    }

    private static class SingletonHolder {
        private final static BLSpUtils INSTANCE = new BLSpUtils();
    }

    public static BLSpUtils getInstance() {
    ...
    public static class DefaultValueBuilder {
        ...
        private String defaultStringValue = BLSpConstant.DEFAULT_STRING_VALUE;
        private int defaultIntValue = BLSpConstant.DEFAULT_INT_VALUE;
        private boolean defaultBooleanValue = BLSpConstant.DEFAULT_BOOLEAN_VALUE;
        private float defaultFloatValue = BLSpConstant.DEFAULT_FLOAT_VALUE;
        private long defaultLongValue = BLSpConstant.DEFAULT_LONG_VALUE;
